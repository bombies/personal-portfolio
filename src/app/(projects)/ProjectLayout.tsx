                ...
                >
                    <CardBody>
                        ...
                        <div className="flex phone:flex-col gap-4">
                            ...
                            <div>
                                <h1 className={`text-5xl  max-w-lg phone:text-3xl text-left font-black mb-3 tracking-wide capitalize text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-rose-600 drop-shadow-md`}>{props.title}</h1>
